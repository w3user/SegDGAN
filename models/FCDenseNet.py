...
from DenseLayer import DenseBlock
from DenseLayer import TransitionDown
from DenseLayer import Bottleneck
from DenseLayer import TransitionUp
...
def FCDenseNetSeg(n_classes):
    return FCDenseNet(
        in_channels=1, down_blocks=(4, 5, 7, 10, 12),
        up_blocks=(12, 10, 7, 5, 4), bottleneck_layers=15,
        growth_rate=16, out_chans_first_conv=64, n_classes=n_classes)
